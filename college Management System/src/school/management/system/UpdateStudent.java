...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    UpdateStudent() {
       ...
       JLabel lblbranch = new JLabel("Gender");
        ...
        labelgen.setBounds(600, 350, 150, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String Class = tfcourse.getText();
     
            
            try {
                String query = "update student set Address='"+address+"', Phone='"+phone+"', Email='"+email+"', class='"+Class+"',where rollno='"+rollno+"'";
