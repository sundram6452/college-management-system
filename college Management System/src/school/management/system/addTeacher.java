...
public class addTeacher extends JFrame implements ActionListener{
    ...
    JTextField tfname, tffname, tfaddress, tfphone, tfemail, tfaadhar,labelempId;
    JDateChooser dcdob,dcdoj;
    JComboBox cbcourse, cbbranch,gender;
    ...
    addTeacher() {
        ...
        dcdoj.setBounds(600, 300, 150, 30);
        add(dcdoj);
        ...
        gender.setBounds(200, 350, 150, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
           ...
           String Gender = (String) gender.getSelectedItem();
            ...
            try {
                String query = "insert into teacher values('"+name+"', '"+fname+"', '"+rollno+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+doj+"', '"+Gender+"', '"+aadhar+"', '"+course+"', '"+branch+"')";
