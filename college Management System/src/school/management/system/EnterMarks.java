...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    EnterMarks() {
        ...
        add(lblclass);
         ...
         cbsclass = new Choice();
        cbsclass.setBounds(200, 110, 150, 20);
        add(cbsclass);
          try {
            connection c = new connection();
            ResultSet rs = c.s.executeQuery("select * from student");
            while(rs.next()) {
               cbsclass.add(rs.getString("class"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            try {
                ...
                String query1 = "insert into subject values('"+crollno.getSelectedItem()+"', '"+cbsclass.getSelectedItem()+"', '"+tfsub1.getText()+"', '"+tfsub2.getText()+"', '"+tfsub3.getText()+"', '"+tfsub4.getText()+"', '"+tfsub5.getText()+"')";
                String query2 = "insert into marks values('"+crollno.getSelectedItem()+"', '"+cbsclass.getSelectedItem()+"', '"+tfmarks1.getText()+"', '"+tfmarks2.getText()+"', '"+tfmarks3.getText()+"', '"+tfmarks4.getText()+"', '"+tfmarks5.getText()+"')";
